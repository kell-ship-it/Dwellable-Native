...
**Status:** 75/144 tickets complete (52%)*, 1 in progress (T-092 — deliverables 1-3 ✅, deliverable 4 in progress: P0, P1, P3, P4, P5, P9, P10, P11 User Scenarios/AC + Technical Tools Needed all COMPLETE; P2, P6, P7 remain; P8's 3 pre-existing Notion comments resolved + reclassified to MVP this session, but P8 still lacks the User Scenarios/AC + Technical Tools Needed subpages P9/10/11 got). Build 107 on TestFlight, Phase 1 complete, Formation Intelligence framework locked, Notion workspace as authoritative source-of-truth. T-099 pricing model backed by real, validated LLM cost/capacity numbers; T-119 token-budget split locked as beta hypothesis. Pillars 3, 4, 5, 9, 10, and 11 FigJam system designs complete and reviewed. **All Pillar 9/10/11 Notion comments resolved (July 20, 2026 evening) — 13 comments across 3 pillars.** **Pillar 8 (Notifications) reclassified MVP (July 20, 2026 evening)** — was "Deferred to Post-MVP," now all 7 stages (A–G) are MVP scope, unified as designed; only the v2 Formation-Intelligence-personalized layer stays Post-MVP. Reflected in Notion, TICKETS.md, and `docs/DEPENDENCY_GRAPH.md` (6 locations). Remaining open questions: T-062/LLM-infra/T-127 (shared cross-pillar blockers) + Growth-tab redundant "All Settings" link vs. gear icon question (now tracked as T-143, needs Kell's decision before that ticket can be built). **P5 elevated to MVP (July 10, 2026):** Screen 1 folded into P6's T-078, Screen 2 is new MVP ticket T-128, both reflected in `docs/DEPENDENCY_GRAPH.md` + Notion mirror. T-062 now confirmed to block three pillars (P3, P4, P5) — flagged as highest-execution-urgency ticket. **Pillar design sequence (as of July 20, 2026 evening):** P9 ✅ → P10 ✅ → P11 ✅ → P8 comments ✅ (subpages still pending) → P6 (Formation Intelligence, next) → P2 (Security) → P7 (canonical "Beta & Marketing" — sequencing label history is confusing here, see July 11 note below; not yet started). **Naming change (July 20, 2026):** "Soaking" permanently renamed to "Prayer" everywhere; "Prayer Frequency" renamed to "Rhythm" (across P9/P11 — the field describes when/where, not how often). *(denominator grows — T-129–T-144 added July 20, 2026 evening [P9/P10/P11 implementation tickets]; T-128 added July 10; T-127 added July 9; T-126 added earlier same evening; T-056 closed as duplicate of T-118)*
...
- [ ] **T-143:** Settings (Nested) — Shared Rhythm Component + Redundancy Resolution (Pillar 11) 🔲 **NOT STARTED**
  - **Purpose:** Locked P11 nested Settings section — Rhythm quick-edit (renamed from "Prayer Frequency" July 20, 2026, see T-132), Notification Preferences link, "All Settings" link.
  - **Scope:** Rhythm quick-edit **must bind to the exact same shared component** as T-132 (P9's Preferences), not a duplicate implementation. Open product question carried from July 11: Growth's top-corner gear icon and the nested "All Settings" text link both route to the same P9 modal — intentional redundancy or should the nested link be removed? **Needs Kell's decision before this ticket can be built.**
