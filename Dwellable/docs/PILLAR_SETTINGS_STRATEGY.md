...
**Pillar:** Settings | **Updated:** May 14, 2026 | **Status:** Strategy Locked
...
- **Access Pattern:** Gear icon in top-right corner (visible across all main tabs) OR nested within Insights tab
...
|----------|--------|-----------|
| **Access pattern** | Gear icon in top-right corner (consistent across tabs) | Visible, standard iOS pattern, matches Reflect competitor |
| **Entry point** | Available from all main tabs (Today, Entries, Create, Insights) | Users should be able to access anytime; not buried in one tab |
...
| **Settings in specific tab only** (e.g., Insights) | Nested like Untold/Reflect | Users might not find it; need access from anywhere |
...
- [ ] Wire gear icon to Settings modal (accessible from all main tabs)
...
| T-XXX | Wire: Gear icon to Settings (visible from all main tabs) | S | T-XXX (all sections) |
...
- **Pillar 6 (Menu Bar):** Gear icon access requires integration with main navigation (T-076+).
