...
- **Pillar 6 (Menu Bar):** Growth is Tab 4 in navigation (P6 responsibility to wire)
- **Pillar 7 (Formation Intelligence):** Post-MVP glossary + emotional depth leverage P7 theme detection
- **Settings Pillar:** Prayer frequency + notification preferences nested in Growth tab
