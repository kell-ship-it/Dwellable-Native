...
- **Key points:**
  - "🔒 Your moments are encrypted and protected — secure from theft or unauthorized access. Dwelly reads them to help you pray, reflect, and see patterns over time, because that's how the app works." *(Updated July 22, 2026 — replaces the old zero-knowledge claim; see docs/PILLAR_2_SECURITY_STRATEGY.md for the model change)*
...
| **Recovery flow if user forgets password?** | ✅ Resolved July 22, 2026 — standard email-based reset, zero impact on data access (see T-067) | N/A — no longer blocked; password reset doesn't touch encryption |
...
**Screenshot needed:** [Screen 6 showing lock icon + "Your moments are secure" + clear language about how Dwelly uses your data]
